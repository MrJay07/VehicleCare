...
<head>
	<title>Best Car Repair & Service Centers in Ghaziabad - VehicleCare</title>
	<!-- Meta tag Keywords -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta charset="UTF-8" />
	<meta name="title" content="Best Car Repair & Service Centers in Ghaziabad - VehicleCare"/>
	<meta name="keywords" content="Car Service,Car Repair, Car Service Center,Car Denting, Car Painting, Car Cleaning, Car Wash, Car Mechanic, Car Garage, Car Service Ghaziabad, Car Repair Ghaziabad ,Car Wheel Repair ,Mercedes Car Service, Audi Car Service, BMW Car Service, Automobile Repair, Ghaziabad, Hyundai , Maruti Suzuki, Honda, Toyota, Chevrolet, Volkswagen , Mahindra, Skoda, Daewoo, Nissan , BMW , Audi, Mercedes." />
	<meta name="description" content="Is your car having trouble? Let us take care of it for you! With VehicleCare's car service centers, car service & repair in Ghaziabad is now easier than ever"/>
	<link rel="canonical" href="car-service-ghaziabad.php" />
	<script>
...
<!-- header -->
			...
			<div class="row">
				<div class="col-lg-5 style-banner">
					<div class="comment-top formBoxShadow ">
						<h1 class="text-dark font-weight-bold">A Simpler Way to Car Service In  <span>Ghaziabad </span> </h1>
				...
				<div class="col-lg-7 banner-img">
					...
					<h1 class="text-dark font-weight-bold mt-5">Looking for Car Service in Ghaziabad??</h1>
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
				...
				<div class="col-lg-4"><br/>
					<h3 class="title-w3 mb-sm-5 mb-4 text-dark font-weight-bold">Car Services Available in Ghaziabad</h3>
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">             
                <div class="col-lg-12">
					...
					<p class="title-para mx-auto mb-sm-5 mb-4">
					Our highly equipped network of garages offers the best car repair & service in Ghaziabad. We incorporate car service packages for every car need and our workshops are equipped to manage multi brand models with the highest degree of expertise. The car service packages under VehicleCare have been customized for your convenience - Basic car service, standard car service, and comprehensive car service. Our starting service package covers the basic needs of a vehicle with under 1000 miles on. The upgraded standard package on the other hand works best for vehicles with over 10000 miles and the comprehensive service is a complete package for cars going under a longer service interval. You can avail premium car service in Ghaziabad through online booking or offline modes and enjoy hassle free service every time. 
					</p>
	...
	<div class="join-w3l1 py-3">
		<div class="container pr-5 py-xl-5 py-lg-3">
			<h3 class="title-w3 title-w3-3 mb-sm-5 mb-4 text-dark font-weight-bold">Why Choose VehicleCare For Car Service In Ghaziabad</h3>
    ...
    <div class="join-w3l1 py-3">
		<div class="container pr-5 py-xl-5 py-lg-3">
			<h3 class="title-w3 title-w3-3 mb-sm-5 mb-4 text-dark font-weight-bold">What Is Included In Car Service In Ghaziabad</h3>
            <p class="title-para mx-auto mb-sm-3 mb-4">Here are all the checkpoints for car repairing in Ghaziabad </p>
            <p class="title-para mx-auto mb-sm-3 mb-4">
          ...
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse18" aria-expanded="false" aria-controls="collapse18">
                How many VehicleCare car service centers are there in Ghaziabad? <i class="fa fa-chevron-down"></i>
              </button>
            </h5>
          </div>
          ...
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse20" aria-expanded="false" aria-controls="collapse20">
                How can I book my car service with VehicleCare in Ghaziabad? <i class="fa fa-chevron-down"></i>
              </button>
            </h5>
          </div>
          ...
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse24" aria-expanded="false" aria-controls="collapse24">
                Do you offer a warranty on my car service in Ghaziabad? <i class="fa fa-chevron-down"></i>
              </button>
            </h5>
          </div>
...
<!-- //Js files -->
	<script>
		...
		$body.on('submit', '#serviceQueryForm', (event) => {
			...
			var target = 'VC Landing Ghaziabad';
			if(campaign_name){
