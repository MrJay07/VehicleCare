...
<head>
	<title>Car Workshop Near Me - VehicleCare</title>
	<!-- Meta tag Keywords -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta charset="UTF-8" />
		
	<meta name="title" content="Car Workshop Near Me - VehicleCare"/>
	...
	<meta name="description" content="Looking for a car workshop nearby. VehicleCare is here to help. We have the best car workshops near you and a wide range of services to choose from." />
    <link rel="canonical" href="car-workshop-near-me.php" />
...
<!-- header -->
			...
			<div class="row">
				<div class="col-lg-5 style-banner">
					<div class="comment-top formBoxShadow ">
						<h1 class="text-dark font-weight-bold">Find a Trusted <span>Car Workshop  Nearby</span> You</h1>
						<form id="serviceQueryForm" class="form-inline mt-5">
							...
							<div class="form-group col-lg-12 mb-4">
								<input class="form-control" type="text" minlength="10" maxlength="10" id="mobile" name="mobile" placeholder="Enter Mobile Number" required="" onpaste="return false;" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
								
							</div>

							<div class="form-group col-lg-12 mb-4">
							    <!-- <input type="text" class="form-control" placeholder="Enter Your Number" name="mobile" id="mobile"> -->
								<select name="city" id="city" class="city list">
				...
				<div class="col-lg-7 banner-img">
					...
					<h1 class="text-dark font-weight-bold mt-5">Looking for a car workshop near you? </h1>
					<p class="title-para mx-auto mb-sm-1 mb-1">VehicleCare is here to help. We have the best car workshops near you and a wide range of services to choose from.</p>
					<div id="demo" class="carousel slide" data-ride="carousel">
						  <!-- The slideshow -->
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="images/near-me/car-mechanic.svg" class="img-fluid">
						    </div>
						    <!-- <div class="carousel-item">
						      <img src="images/near-me/car-mechanic1.svg" class="img-fluid">
						    </div> -->
						  </div>
					</div>
				</div>
	...
	<section class="pricing bg-light py-5">
		<div class="container py-lg-3">
			<div class="inner-sec">
				<h3 class="title-w3 mb-sm-5 mb-4 text-dark font-weight-bold">Car Workshop Near Me?</h3><br/>
				<p class="mb-3">
                    Keep your vehicle on the road with automotive repair services from our trusted car workshops near you. Whether it's a car service or car repair we're only too happy to oblige. We fix all makes and models, so if you're having issues with your car or don't know what's wrong, we're here to help!
				</p>

				<p class="mb-3">
					<h6 class="mb-2"><b>VehicleCare Workshop Benefits</b></h6>

                    <b>Get Rewarded   -</b> Save money on car service & repair. Get cashback & rewards on every car service with VehicleCare<br/>

                    <b>Fix-It When You Need It -</b>Schedule service appointments on our workshops whenever and wherever you are - we'll do the rest<br/>

                    <b>Stay Connected -</b> Receive periodic updates on repairs and service specials through text messages or email
                </p>

                <p class="mb-3">
                    <h6 class="mb-2"><b>VehicleCare Workshop  Features</b></h6>

                    <b>Skilled Mechanics -</b>  VehicleCare has got trained service technicians ready to diagnose, service, repair, and maintain all vehicle models - whether new or old<br/>

                    <b>100% Quality Repairs -</b> We know cars like the back of our hands. With over a decade of combined experience, our master technicians are experts in their field.<br/>

                    <b>Wide Range of Services -</b> Whether it's exhaust repair, brake service, or engine replacement, VehicleCare covers a variety of services both in and out of the workshop.
                </p>
			</div>
		</div>
	</section>
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
				<div class="col-lg-4"><br/>
					<h3 class="title-w3 mb-sm-5 mb-4 text-dark font-weight-bold">Services We Offer</h3>
	...
	<section class="pricing bg-light py-5 d-none d-md-block d-lg-block" id="pricing">
		<div class="container py-lg-3">
			<div class="inner-sec">
				<h3 class="title-w3 mb-sm-5 mb-4 text-dark font-weight-bold">VehicleCare Vs Competitors</h3><br/>
	...
	<div class="join-w3l1 py-3">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title-w3 title-w3-3 mb-sm-5 mb-4 text-dark font-weight-bold">why choose vechiclecare</h3>
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="col-lg-12 w3_testimonials_grid ">
							<h4 class="text-light">I've been looking for a reliable car workshop near me, and VehicleCare has been great. "VehicleCare is a lifesaver! I run a small business and my car is vital for my work. I was starting to get paranoid about the costs of repair and decided to give VehicleCare a try. The workshop manager there found the problem, fixed it, and returned our car in no time flat - all at a really affordable price. Thank you so much!" 
							</h4>
							<h5 class="mt-3"> Arjun Saxsena <img src="https://vehiclecare.in/images/te1.jpeg" alt=" " vspace="5" class="img-fluid rounded-circle" /></h5>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="col-lg-12 w3_testimonials_grid ">
							<h4 class="text-light">"I'm thrilled to say that I got my car serviced at VehicleCare. They did a great job and the customer service was excellent. The price for the service was one of the lowest I could find, and it was an easy drive from my house."
							</h4>
							<h5 class="mt-3">Abhay Bhatt <img src="https://vehiclecare.in/images/te2.png" alt=" " vspace="5" class="img-fluid rounded-circle" /></h5>
						</div>

					</div>
					<div class="col-lg-4">
						<div class="col-lg-12 w3_testimonials_grid ">
							<h4 class="text-light">"VehicleCare is the best car workshop near me. They've been able to quickly diagnose my car and complete the repairs, saving me a ton of money in the process."
							</h4>
							<h5 class="mt-3">Raj Gandhi <img src="https://vehiclecare.in/images/te3.jpeg" alt=" " vspace="5" class="img-fluid rounded-circle" /></h5>
      ...
      <div class="card">
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              ...
              How can I find the best car workshop near me? <i class="fa fa-chevron-down"></i>
              </button>
            </h5>
          </div>
          <div id="collapse5" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
            We've partnered with the best car workshops in your 40+ cities, so you can easily find a trustworthy car workshop near you. You just need to select your city and state and we will help you find the best automotive workshops near you            </div>
          </div>
      </div>
      <div class="card">
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              ...
              What happens if my car needs a service but I can't get to the car workshop? <i class="fa fa-chevron-down"></i>
              </button>
            </h5>
          </div>
          <div id="collapse6" class="collapse false" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
            In such case, you can always avail facilities like doorstep car service or free pick up & drop. VehicleCare will come to you and do the necessary service so that you don't have to take days off work. Our support team will provide you with updates on your car servicing. Also, you can track the status of your car serving on our website.            </div>
          </div>
      </div>
      <div class="card">
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              ...
              How often should I get my car checked? <i class="fa fa-chevron-down"></i>
              </button>
            </h5>
          </div>
          <div id="collapse9" class="collapse false" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
            You should get your car checked every 6 months to make sure your gas system and engine are clean. You should also get a complete check-up every year to ensure that all the key components of your vehicle are in good condition.            </div>
          </div>
      </div>
      <div class="card">
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              ...
              How can I book a car service with VehicleCare’s auto workshop nearby me? <i class="fa fa-chevron-down"></i>
              </button>
            </h5>
          </div>
          <div id="collapse77" class="collapse false" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
            We want to make it as convenient as possible for our customers to book a service with us in order to save money. That is why we allow our customers to book the vehicle service they need directly through our website or app that is available on both Android and IOS. It is simple, fast, and easy. Alternatively, you can give us a call on 9911020209 and one of our consultants will be able to help            </div>
          </div>
      </div></div>
		</div>
	</div>
	...
	<div class="modal" id="SubmitCheck" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			...
			<div class="modal-body">
				<div class="form-group">
					<input id="inputOtp" placeholder="Enter The OTP" type="text" name="" class="form-control" id="">
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" id="submitOtp" class="col s12 btn btn-large waves-effect waves-light red white-text">Continue</button>
			</div>
			</div>
		</div>
	</div>
	...
	<script>
		...
		window.onload = function() {
			var firebaseConfig = {
				...
				authDomain: "AIzaSyA1maZ4DWkW4jn2HCy7lze3pgpWCvZatqc",
				databaseURL: "AIzaSyA1maZ4DWkW4jn2HCy7lze3pgpWCvZatqc",
				projectId: "AIzaSyA1maZ4DWkW4jn2HCy7lze3pgpWCvZatqc",
				storageBucket: "AIzaSyA1maZ4DWkW4jn2HCy7lze3pgpWCvZatqc",
				messagingSenderId: "AIzaSyA1maZ4DWkW4jn2HCy7lze3pgpWCvZatqc",
				appId: "AIzaSyA1maZ4DWkW4jn2HCy7lze3pgpWCvZatqc"
			};
			// Initialize Firebase
			...
			document.getElementById('mobile').addEventListener('keyup', updateSignInButtonUI);
			document.getElementById('mobile').addEventListener('change', updateSignInButtonUI);
		}
		function updateSignInButtonUI() {
			var email = $('#mobile').val().trim();
			if(!email){
		...
		$body.on('submit', '#serviceQueryForm', (event) => {
			...
			var target = 'VC Landing Workshop';
			var brandName = $(`.car_brand.query option[value="${carBrand}"]`).text();
			var modelName = $(`.car_model_quotes option[value="${carModel}"]`).text();
			let paramsForLSQ = {
				phone: mobile,
				city: city,
				brand: brandName,
		...
		$body.on('click', '#submitOtp', (event) => {
			event.preventDefault();
			var otp = $('#inputOtp').val();
			var mobile = $('#mobile').val().trim();
			confirmationResult.confirm(otp).then(function (result) {
				otpVerification({mobile},(response) => {
					location.href = "thanku.php";
				});
			}).catch(function (error) {
			console.log(error);
				if(error.code=="auth/invalid-verification-code"){
					alert("Please enter a valid code or request a new code by selecting resend.");
				}else{
