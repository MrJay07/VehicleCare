...
<head>
	<title>Expert Car Mechanics Near You - VehicleCare</title>
	<!-- Meta tag Keywords -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta charset="UTF-8" />
		
	<meta name="title" content="Expert Car Mechanics Near You - VehicleCare"/>
	...
	<meta name="description" content="Your search for car mechanic near me ends here. With VehicleCare's network of expert mechanics, finding an auto mechanic near you is an easy search away" />
...
<!-- header -->
			...
			<div class="row">
				<div class="col-lg-5 style-banner">
					<div class="comment-top formBoxShadow ">
						<h1 class="text-dark font-weight-bold">Your search for <span>"Car Mechanic Near Me"</span> Ends Here</h1>
				...
				<div class="col-lg-7 banner-img">
					...
					<h1 class="text-dark font-weight-bold mt-5">Looking For Car Mechanic Near You?</h1>
					<p class="title-para mx-auto mb-sm-1 mb-1">Look no further! With VehicleCare's network of mechanics, finding an auto mechanic near you is an easy search away.</p>
	...
	<section class="pricing bg-light py-5">
		<div class="container py-lg-3">
			<div class="inner-sec">
				<h3 class="title-w3 mb-sm-5 mb-4 text-dark font-weight-bold">Car Mechanic Near Me?</h3><br/>
                <p class="title-para mx-auto mb-3">Don't let a breakdown leave you stranded. With Car Mechanic Near Me, we make it easy to find the best car service near you at a time that's convenient for you. Cars are expensive investments so we want to make sure you find a mechanic that is fast, reliable, and affordable. With just a few clicks you can find an expert car mechanic near you to fix your car's problem without any wasted time or effort.
				</p>
				
				<p class="mb-2"><b>How It Works?</b></p>
				<p class="title-para mx-auto mb-3">- Enter your location and find a car mechanic nearby you</br>
					- Get the best quotes for your car service or wait for a call back from one of our mechanics</br>
					- Schedule a service appointment on your preferred date & time

				<p class="mb-2"><b>VehicleCare Features</b></p>
            
				<p>
					<b>Quality Assurance  - </b>
					We believe in serving our customers right the first time and the nth time because we live up to our promises and we don't settle for anything less than perfect service.
				</p>
				<p>
					<b>Hassle-Free </b>
					Schedule an appointment at a time that's convenient for you.   
				</p>
				<p>
					<b>Get Help Now - </b>
					Get personalized quotes from the best mechanics near you with just a few clicks of a button.
				</p>
				<p>
					<b>Lower Cost - </b>
					Whether it's a quick fix or a more complicated job, we will make sure you get the best service at the lowest price.
				</p>
				<p>
					<b>Time Saved - </b>
					No need to call around or visit several shops - we'll do it for you!
				</p>
				<p>
					<b>Get Support - </b>
					Great customer service is just a phone call away at all times. 
				</p>
				<p>
					<b>Get Reassurance - </b>
					Leave feeling confident about your next auto repair after reading reviews from other customers.  
				</p>
			</div>
		</div>
	</section>
...
<!-- //Js files -->
	<script>
		...
		$body.on('submit', '#serviceQueryForm', (event) => {
			...
			var target = 'VC Landing Mechanic';
